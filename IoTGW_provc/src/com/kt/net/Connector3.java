...
public abstract class Connector3 implements Runnable {
	...
	public Connector3(String ipAddr, int port) {
	...
	public Connector3(CommandReceiver receiver, String ipAddr, int port) {
