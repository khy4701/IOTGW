...
public abstract class Connector2 implements Runnable {
	...
	public Connector2(Receiver receiver, String ipAddr, int port) {
 ...
 */
	public Connector2(ConnectObserver connectObserver, Receiver receiver, String ipAddr, int port) {
...
//		}
		...
		socket = null;
//		connectObserver.disconnect(this);
	}
