...
public class ProfStsNotification implements DBMListener{

	private static Logger logger = LogManager.getLogger(ProfStsNotification.class);
	
	@SuppressWarnings("static-access")
	@POST 
	@Path("noti")
	@Produces("application/json;charset=UTF-8")
	public Response profStatusNoti(@Context HttpServletRequest req, @HeaderParam("O_SYS_CD") @Encoded String osysCode, @HeaderParam("T_SYS_CD") @Encoded String tsysCode,
		...
		String apiName = ApiDefine.PROF_STS_CHANGE_NOTI.getName();
